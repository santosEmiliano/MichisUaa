    ...
    >
      <form className="space-y-6">
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <input
            type="date"
            className="w-56 bg-gris border border-sidebar-separador rounded-xl px-4 py-3 text-secondary focus:outline-none focus:border-acento-naranja transition-colors"
          />
        </div>
      </form>
    </ModalCrud>
